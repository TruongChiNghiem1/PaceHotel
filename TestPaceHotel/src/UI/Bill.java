...
public class Bill extends JFrame {
	...
	public Bill() {
		...
		String[] tieuDe = {"STT","Room ID","Days","Service Name","Qty","Price","Node","Amount"};
		...
		TableColumn Qty = columnModel.getColumn(4);
		Qty.setPreferredWidth(40);
		TableColumn ServiceName = columnModel.getColumn(3);
		ServiceName.setPreferredWidth(100);
		TableColumn Amount = columnModel.getColumn(7);
