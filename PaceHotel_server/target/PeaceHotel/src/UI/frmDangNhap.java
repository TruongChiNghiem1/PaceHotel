...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		pnLeft.add(lblLogo);
		lblLogo.setBounds(60, -20, 250, 330);
		...
		pnLeft.add(txtPass = new JPasswordField());
		...
		pnLeft.add(btnExit = new JButton("Exit"));
		btnExit.setBounds(btnLogin.getX() + 100, btnLogin.getY(), 100, 30);
